...
public class FetchTrailerIntentService extends IntentService {

	public static final String TAG = FetchTrailerIntentService.class.getSimpleName();
	private static final String MOVIE_ID_EXTRA = "intentExtraMovieId";
	public static final String DATA_LOADED = "intentTrailerDataLoaded";
	public static final String DATA_LOADED_EXTRA = "intentTrailerResponse";
	private Gson gson;

	public FetchTrailerIntentService() {
		super(FetchTrailerIntentService.class.getSimpleName());
	...
	protected void onHandleIntent(Intent intent) {
		...
		final TrailerResponse response = gson.fromJson(jsonResponse, TrailerResponse.class);
	...
	public static Intent getIntent(Context context, long id) {
		Intent i = new Intent(context, FetchTrailerIntentService.class);
